...
HF_REPO_ID = "meli143/resnet50-mammogram-clahe-final"
HF_FILENAME = "resnet50_clahe_best.keras"

IMG_SIZE = 224
THRESHOLD = 0.3907

TEST_AUC = 0.7457
MULTISEED_AUC = "0.7296 ± 0.0105"
...
if input_method == "Use a sample image":
    ...
    st.write(
        "Choose one of the ten demonstration mammograms."
    )
